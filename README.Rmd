...
<hr>
*If you enjoy my R community contributions, consider* ***[buying me a coffee in Ko-fi](https://ko-fi.com/leonawicz)*** *(or through PayPal <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=DHMC76S85GJCY&source=url"><img src="https://www.paypalobjects.com/en_US/i/btn/btn_donate_SM.gif" /></a>) so I can keep developing and maintaining this and other packages :)*
<hr>
...
Please note that the `rtrek` project is released with a [Contributor Code of Conduct](https://leonawicz.github.io/rtrek/CODE_OF_CONDUCT.html). By contributing to this project, you agree to abide by its terms.
